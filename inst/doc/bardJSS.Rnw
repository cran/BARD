...
<<rplot1,eval=FALSE,results=hide,echo=FALSE>>=
 plot(kplan,cols=colorRampPalette(c("red","grey"))(5),axes=F)
@
  \begin{figure}[!h]
<<plot1a, fig=TRUE,width=7>>=
<<rplot1>>
@
...
<<rplot3,eval=FALSE,results=hide,echo=FALSE>>=
plot(summary(samples))
@
  \begin{figure}[!h]
<<plot3a, fig=TRUE,width=7>>=
<<rplot3>>
@
